<style>
    ...
    .figure-learn-process .widget__figure {
        margin: 0;
        vertical-align: middle;
    }

    .desc-welcome-collaborator {
        font-size: 0.95rem;
    }
        ...
        <div class="row middle-xs">
            ...
            <div class="col col--md-8 col--xl-7">
                <h2 class="widget__title">
                    <a href="http://portal.stt.intranet.bb.com.br/processo/">Bem vindo Colaborador!</a>
                </h2>
                <p class="desc-welcome-collaborator">Encontre as instruções para obter os primeiros acessos e configurar o seu ambiente de trabalho.</p>
                ...
                <ul class="list list--dot row mb-0 mb-sm-3">
                    ...
                    <li class="list__item col col--sm-6  list__item--790">
                        <a target="_blank"
                           href="https://intranet1.bb.com.br/inc/conteudoAssunto.ctr?comando=visualizarConteudoBuscador&amp;codigoAssunto=1187&amp;numeroConteudo=2996&amp;versaoConteudo=11&amp;naturezaInformacaoConteudo=1&amp;tipoConteudo=1&amp;secao=4"
                           class="list__link fw-450">Configuração de ambiente</a>
                    </li>
