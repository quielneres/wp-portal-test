		...
		<div class="row middle-xs">
			...
			<div class="col col--md-8 col--xl-7">
				<h2 class="widget__title">
					<a href="#">Bem vindo Colaborador!</a>
				</h2>
				<p class="desc-welcome-collaborator">Encontre as instruções para obter os primeiros acessos e configurar
					o seu ambiente de trabalho.</p>
