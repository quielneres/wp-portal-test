...
class Walker_Process_Menu extends Walker_Nav_Menu {
...
/**
 * process_menu returns an instance of the Walker_Process_Menu class with the following arguments
 ...
 * @return [type]
 */
function process_menu($location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null){
